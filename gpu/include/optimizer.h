...
class Optimizer{
    public:
        Optimizer() = default;
        Optimizer(std::shared_ptr<nnet::Layer> layer, float learning_rate): layer(layer), learning_rate(learning_rate){}
        virtual ~Optimizer(){};
...
class RMSProp : public Optimizer{
    public:
        RMSProp() = default;
        RMSProp(std::shared_ptr<nnet::Layer> layer, float learning_rate, float beta); 
        ~RMSProp() = default;
